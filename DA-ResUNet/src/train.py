...
from utils import calculate_metrics, calculate_hd95
...
def validate(loader, model):
    model.eval()
    dice_sum, iou_sum, hd95_sum = 0, 0, 0
    steps = 0
    ...
    with torch.no_grad():
        for data, targets in loader:
            ...
            # 计算指标
            d, i, _, _ = calculate_metrics(preds, targets)
            h = calculate_hd95(preds, targets)
    ...
    return dice_sum / steps, iou_sum / steps, hd95_sum / steps
...
def main():
    ...
    for epoch in range(1, Config.NUM_EPOCHS + 1):
        ...
        # 验证
        dice, iou, hd95 = validate(val_loader, model)
        ...
        print(f"   >>> Val Dice: {dice:.4f} | IoU: {iou:.4f} | HD95: {hd95:.4f}")
